...
<div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
    <div class="row">
        <div class="col-lg-6 px-0">
            <h1 class="display-4 fst-italic">The Transformative Power of Art: Exploring Diverse Artistic Expressions</h1>
            <p class="lead my-3">Art has the power to move us, to challenge our perceptions, and to inspire change. From traditional paintings to cutting-edge digital creations, the world of visual art is a rich tapestry of creativity and expression. In this blog post, we will delve into the diverse world of artworks, exploring various forms and the impact they have on artists and art enthusiasts alike.</p>
            <p class="lead mb-0"><a href="{{route('Blog')}}" class="text-body-emphasis fw-bold">Continue reading...</a></p>
        </div>
        <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <img src="slider1.jpg" alt="Art Image" class="img-fluid rounded">
        </div>
    </div>
</div>
...
<section class="py-5 text-center container bg-body-secondary">
    <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-dark text-dark">Visual Art Gallery</h1>

            <p class="lead text-body-secondary">Welcome to the Visual Art Gallery, an immersive online platform dedicated to celebrating and showcasing diverse artistic talents from around the world. Whether you are an art enthusiast, a budding artist, or a seasoned curator, our gallery offers a vibrant space where creativity meets community.</p>
            <p>
                <a href="{{route('about')}}" class="btn btn-primary my-2">About Us</a>
                <a href="{{route('contactus')}}" class="btn btn-primary my-2">Contact Us</a>
            </p>
        </div>
    </div>
</section>
  ...
  <div class="d-flex justify-content-center align-items-center" style="height: 10vh;">
    <div class="d-flex align-items-center ">
        <h1 class="fw-light mb-0 me-5">Artists</h1>
       <a href="{{route('artist')}}">
                    ...
                    <?php foreach ($data as $artist): ?>
                        <div class="col">
                            <div class="card shadow-sm">
                                <img src="<?php echo asset($artist->image1); ?>" class="bd-placeholder-img card-img-top" width="100%" height="225" alt="Image">
                                <div class="card-body">
...
@if(auth()->check()) <!-- Check if the user is logged in -->
    @if(auth()->user()->id === $artist->user_id) <!-- Check if the logged-in user owns the profile -->
...
@endif
  ...
  <div class="d-flex justify-content-center align-items-center" style="height: 10vh;">
    <div class="d-flex align-items-center">
        <h1 class="fw-light mb-0 me-5">Exhibitions</h1>
            ...
            <div class="container px-4">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    <?php foreach ($exhibitions as $exhibition): ?>
                        <div class="col">
                            <div class="card shadow-sm">
                                <img src="<?php echo asset($exhibition->image1); ?>" class="bd-placeholder-img card-img-top" width="100%" height="225" alt="Image">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo $exhibition->Name; ?></h5>
                                    <p class="card-text"><?php echo $exhibition->Bio; ?></p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
