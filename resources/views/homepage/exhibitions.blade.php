...
<head>
    ...
    <title>Multan Art Gallery - Exhibitions</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('exhibitions') }}">Exhibitions</a>
                        </li>
                        <li class="nav-item">
    ...
    <main>
        <section class="hero-section animate__animated animate__fadeIn">
            <div class="hero-overlay">
                <div class="hero-text">
                    <h1>Exhibitions</h1>
                    <p>Explore our curated collection of exhibitions showcasing diverse artistic talents from around the world.</p>
                </div>
            </div>
        </section>

        <section class="exhibitions-section animate__animated animate__fadeIn">
            <div class="container">
